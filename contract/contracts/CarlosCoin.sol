...
contract CarlosCoin is ERC20 {
    ...
    constructor(uint256 _initialSupply, uint256 _price ) ERC20("CarlosCoin", "CAA") {
        owner = msg.sender;
    ...
    function buyTokens() public payable duringICO {
        uint256 tokensPerEth = 100; // 1.0 Sepolia-ETH = 100 CarlosCoins
